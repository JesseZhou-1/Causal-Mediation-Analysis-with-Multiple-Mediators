...
folder = 'natl_2003_sens_244'  # Define the folder where files will be stored.
...
trainMed(path=path, dataset_name=dataset_name, treatment='a', confounder=["c1", "c2", "c3", "c4"], mediator=["l", "m"], outcome='y',
           test_size=0.2, cat_var=["a", "l", "m", "y", "c1", "c2", "c3", "c4"], sens_corr=corr_strength_1, seed_split=1,
           model_name=path + 'sens_244',
...
simMed(path=path, dataset_name=dataset_name, model_name=path + 'sens_244', intv_med=None, n_mce_samples=100000, seed=1, inv_datafile_name='sens_244_100k',
