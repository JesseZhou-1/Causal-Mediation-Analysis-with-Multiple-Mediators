...
compute_true_pse_exp4 <- function(N_truth = 2000000L, par = exp4_params, d = 5, dstar = 0) {
  set.seed(99999)
  C <- rnorm(N_truth)
...
compute_true_intv_exp4 <- function(N_truth = 2000000L, par = exp4_params, d = 5, dstar = 0) {
  set.seed(99999)
  C <- rnorm(N_truth)
